...
class gsp_metals_userlist_gsp extends GroovyPage {
...
printHtmlPart(13)
invokeTag('sortableColumn','g',29,['property':("passwort"),'title':(message(code: 'user.passwort.label', default: 'Passwort'))],-1)
printHtmlPart(14)
loop:{
int i = 0
...
invokeTag('link','g',37,['action':("show"),'id':(userInstance.id)],3)
printHtmlPart(17)
expressionOut.print(fieldValue(bean: userInstance, field: "passwort"))
printHtmlPart(18)
i++
}
}
printHtmlPart(19)
invokeTag('paginate','g',46,['total':(userInstanceTotal)],-1)
printHtmlPart(20)
})
...
public static final long LAST_MODIFIED = 1545312441000L
