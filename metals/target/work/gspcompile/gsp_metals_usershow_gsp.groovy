...
class gsp_metals_usershow_gsp extends GroovyPage {
...
printHtmlPart(17)
if(true && (userInstance?.passwort)) {
printHtmlPart(18)
invokeTag('message','g',37,['code':("user.passwort.label"),'default':("Passwort")],-1)
printHtmlPart(19)
invokeTag('fieldValue','g',39,['bean':(userInstance),'field':("passwort")],-1)
printHtmlPart(16)
}
printHtmlPart(20)
createTagBody(2, {->
printHtmlPart(21)
invokeTag('hiddenField','g',47,['name':("id"),'value':(userInstance?.id)],-1)
printHtmlPart(22)
createTagBody(3, {->
invokeTag('message','g',48,['code':("default.button.edit.label"),'default':("Edit")],-1)
})
invokeTag('link','g',48,['class':("edit"),'action':("edit"),'id':(userInstance?.id)],3)
printHtmlPart(22)
...
public static final long LAST_MODIFIED = 1545312457000L
