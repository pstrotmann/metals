...
class gsp_metals_userlogin_gsp extends GroovyPage {
...
printHtmlPart(18)
invokeTag('actionSubmit','g',32,['class':("save"),'action':("login"),'value':(message(code: 'default.button.login.label', default: 'Login'))],-1)
printHtmlPart(19)
})
invokeTag('form','g',34,['method':("post")],2)
printHtmlPart(20)
})
...
public static final long LAST_MODIFIED = 1545312318000L
