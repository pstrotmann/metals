...
class gsp_metals_useredit_gsp extends GroovyPage {
...
createTagBody(2, {->
printHtmlPart(20)
invokeTag('hiddenField','g',31,['name':("id"),'value':(userInstance?.id)],-1)
printHtmlPart(20)
invokeTag('hiddenField','g',32,['name':("version"),'value':(userInstance?.version)],-1)
printHtmlPart(21)
...
invokeTag('form','g',40,['method':("put")],2)
printHtmlPart(25)
})
...
public static final long LAST_MODIFIED = 1545312429000L
