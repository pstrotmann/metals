...
class gsp_metals_geschenkcreate_gsp extends GroovyPage {
public String getGroovyPageFileName() { "/WEB-INF/grails-app/views/geschenk/create.gsp" }
public Object run() {
Writer out = getOut()
...
printHtmlPart(1)
invokeTag('set','g',5,['var':("entityName"),'value':(message(code: 'geschenk.label', default: 'Geschenk'))],-1)
printHtmlPart(1)
createTagBody(2, {->
createTagBody(3, {->
...
invokeTag('eachError','g',25,['bean':(geschenkInstance),'var':("error")],3)
printHtmlPart(18)
})
invokeTag('hasErrors','g',27,['bean':(geschenkInstance)],2)
printHtmlPart(11)
createTagBody(2, {->
printHtmlPart(19)
...
invokeTag('form','g',35,['url':([resource:geschenkInstance, action:'save'])],2)
printHtmlPart(22)
})
...
public static final long LAST_MODIFIED = 1595514303000L
